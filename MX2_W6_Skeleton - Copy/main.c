...
int Turn(int Angle){                                                    // function for wheel turn angle
    ...
    /*while (C_Angle <= Angle){
        ...
        while(!PIR1bits.RC1IF);
        Current_Dist2 = RCREG1;
        Current_Dist = Current_Dist2;
        
        C_Angle += Current_Dist;
     *
    } */
}
